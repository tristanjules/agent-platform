# mesh-send-tool Specification

## Purpose
Agent tool for sending messages over the LoRa mesh network. Allows the conversational agent to transmit messages to peers by name or node ID.

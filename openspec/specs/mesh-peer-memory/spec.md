# mesh-peer-memory Specification

## Purpose
Rich per-peer fact storage and interaction history. Provides the agent with contextual memory about mesh peers, enabling personalized and context-aware communication.

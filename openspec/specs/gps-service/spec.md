# gps-service Specification

## Purpose
GPS location provider interface with a stub implementation. Supplies location data for mesh heartbeats and location sharing. Designed for future hardware GPS integration.

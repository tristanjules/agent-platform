# prompt-engineering-tools Specification

## Purpose
Provides engineered system prompt addenda that improve small-model tool-calling accuracy through few-shot examples, negative examples, and explicit behavioral guidance for the mesh tool set.
